...
for i=1:5
    muscle_len_vec(i) = muscle_length(muscles.origin_body{i},muscles.insertion_body{i},muscles.origin(i,:),muscles.insertion(i,:),[qq1,qq2],muscles.wrapping(i));
...
react_angle = reaction_angle(q,akt,params,muscles);
